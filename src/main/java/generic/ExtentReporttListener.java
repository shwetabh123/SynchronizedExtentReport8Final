 ...
 * 
 * import org.apache.log4j.Logger; import org.testng.ITestContext; import
 ...
 * private static ThreadLocal parentTest = new ThreadLocal(); // private static
 * ThreadLocal test1 = new ThreadLocal();
 * 
 * 
 * //Extent Report Declarations private static ExtentReports extent =
 * ExtentManager.getExtentReport(); private static ThreadLocal<ExtentTest> test
 * = new ThreadLocal<>();
 * 
 * 
 * // public static ExtentReports extent; public static ExtentTest extentTest;
 * 
 * 
 ...
 * }
 * 
 * @Override public synchronized void onFinish(ITestContext result) { //
 * extent.flush();
 * 
 * 
 * 
 ...
 * 
 * @Override public synchronized void onTestStart(ITestResult result) {
 * 
 * 
 * 
 * //ExtentTest extentTest =
 * extent.createTest(result.getMethod().getMethodName(),result.getMethod().
 * getDescription());
 * 
 ...
 * 
 * // ExtentTest extentTest =
 * extent.createTest(result.getMethod().getMethodName(),"Test Case is passed");
 * 
 * 
 * // extentTest.log(Status.PASS,
 * "TEST CASE PASSED IS ->"+result.getMethod().getMethodName()+"is passed");
 ...
 * extent report
 * 
 * // extent.flush(); Reporter.log(result.getMethod().getMethodName()+
 ...
 * 
 * 
 * log.warn(result.getMethod().getMethodName()+
 * "Test Skipped..."+result.getThrowable());
 * 
 * }
 * 
